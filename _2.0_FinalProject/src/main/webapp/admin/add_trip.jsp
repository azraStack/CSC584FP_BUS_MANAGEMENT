...
<div class="backg">
			<div class="card" style="width: 80%; margin-left:10%; margin-right:10%;">
				<div class="bg-soft-primary">
					<div class="card-body">
						<h4 class="card-title">Add New Trip <br></h4>
...
<path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1z"></path>
						...
						<form action="AddTripController" method="post"><br>
						<div class="row">
							<div class="col-md-6 mb-3" style="width:100%">
								
								<label for="adminid">Admin ID</label>
								<input class="form-control" type="text" id="adminid" name="adminid" value="${admin.adminid}" readonly>
								<label for="busid">Bus ID</label>
								
								<select class="form-control" id="busid" name="busid">
								<c:forEach items="${bus}" var="bus">
								<option value="<c:out value="${bus.busid}"/>"><c:out value="${bus.busid}"/></option>
								</c:forEach>
								</select>
						...
						<div class="row">
							<div class="col-md-6 mb-3" style="width:100%">
								...
								<input class="form-control" type="text" id="price" name="price" placeholder="RM XX.XX" required>
							</div>
						</div>

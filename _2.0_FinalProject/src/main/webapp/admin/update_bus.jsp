...
<path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1z"></path>
				...
				<h4 class="card-title">UPDATE BUS <br></h4>
				
				<form action="UpdateBusController" method="post">
					<div class="row">
								<div class="col-md-6 mb-3">
									<label for="busid">BUS ID</label>
									<input class="form-control" type="text" id="busid" name="busid" value="${bus.busid}" required >
								</div>
								<div class="col-md-6 mb-3">
									<label for="buscompany">BUS COMPANY</label>
									<input class="form-control" type="text" id="buscompany" name="buscompany" value="${bus.buscompany}" required >
								</div>
								<div class="col-md-6 mb-3">
									<label for="drivername">DRIVER NAME</label>
									<input class="form-control" type="text" id="drivername" name="drivername" value="${bus.drivername}" required >
								</div>
					</div>
							<br>
							<div
...
<script>
	function UpdateSuccess() {
	  alert("Successfully Update Bus details!");
	}
</script>

...
<path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1z"></path>
				...
				<a href="AddTripController"
								data-toggle="tab" aria-expanded="false" class="nav-link"
								style="border-radius: 15px; margin: 10px; color: black">ADD NEW TRIP
				</a>
						  ...
						  <tr>
						      ...
						      <td>
								<button type="button" class="btn btn-success"
									...
									onclick="document.location='UpdateTripController?tripid=${trip.tripid}'">UPDATE</button>
									<input type="hidden" id="tripid-${trip.tripid}" value="<c:out value="${trip.tripid}"/>">
									<a class="btn btn-danger" onclick="confirmDelete('${trip.tripid}')">Delete</a>
							  </td>
		...
		<script>
			function confirmDelete(index) {
				var tripid = $("#tripid-" + index).val();
				var r = confirm("Are you sure want to delete this trip " + tripid + "?");
				if (r == true) {
					location.href = 'DeleteTripController?tripid='+ tripid;
					alert("Bus deleted!");
				} else {
					return false;
				}

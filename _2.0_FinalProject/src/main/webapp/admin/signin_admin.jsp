				...
				<main class="form-signin">
					<form action="../LoginAdminController" method="post">
						...
						<ul class="nav nav-pills navtab-bg nav-justified">
							...
							data-toggle="tab" aria-expanded="true" class="nav-link">User</a></li>
							<li class="nav-item"><a href="../admin/signin_admin.jsp" 
							data-toggle="tab" aria-expanded="false" class="nav-link active">Admin</a></li>
						</ul><br><br>
						<h1 class="h3 mb-3 fw-normal">Admin Login</h1>
						<!-- Input for admin id and password -->
						<div class="mb-3">
							<input class="form-control" type="text" placeholder="Admin ID" name="adminid" required>
						</div>
						<div class="mb-3">
							<input class="form-control" type="password" placeholder="Password" name="adminpassword" required>
						</div>

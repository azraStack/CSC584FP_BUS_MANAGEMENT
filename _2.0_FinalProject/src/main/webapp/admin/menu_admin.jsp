		...
		<br>
			<div class="card" style="width: 90%; margin: auto;">
				<div class="tile_div" style="text-align: center;">
				    <a style="margin-right:10px; text-decoration:none" href="ListAllTripController">VIEW ALL TRIPS</a>
				    <a style="margin-right:10px; text-decoration:none" href="ListAllBusController">VIEW ALL BUSES</a>
				    <!-- <a style="margin-right:10px; text-decoration:none" href="generateReport">GENERATE REPORT</a> -->		
				    <div class="clear"></div>
				</div>
			</div>
		<br>
					...
					<div class="card-body">
						...
						<div class="table-responsive mt-4">
							<table class="table table-centered table-nowrap">
								<tbody>
									<tr>
										...
										<td style="width: 30%">
											<h5 class="mb-0">${admin.adminid}</h5>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<h5 class="mb-0">${admin.adminname}</h5>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<h5 class="mb-0">${admin.adminphoneno}</h5>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<h5 class="mb-0">${admin.adminemail}</h5>
										</td>
									</tr>
								</tbody>
							</table>
							<div style= "display:flex; justify-content:center">
						        ...
						        <button type="button" class="btn btn-success me-3 col-6" onclick="document.location='UpdateAdminController?adminid=${admin.adminid}'">
						          UPDATE
						        </button>
      						</div>		
						</div>
